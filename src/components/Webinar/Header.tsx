      ...
      <div className="bg-[#1B2A41]/80 pt-5 px-5 h-full ">
        <div className="flex justify-between items-center ">
          ...
          <NavHashLink smooth to={"#register"}>
            <Button
              variant="secondary"
              className=" mt-1 cursor-pointer hidden sm:flex"
            >
        ...
        <div className="flex flex-col justify-center items-center py-[3em] px-[1em] ">
          ...
          <p className="sm:self-center decorate-[#2F9E44] text-wrap capitalize font-medium transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
            <span className="text-[#2F9E44] font-semibold text-xl">
              upcoming:{" "}
            </span>
            Understanding Start up Compliance{" "}
          </p>
          <div className="flex flex-row justify-start items-center mt-1 mb-5 flex-wrap gap-3">
          ...
          <NavHashLink smooth to={"#register"}>
            <Button
              variant="secondary"
              className=" mt-1 cursor-pointer sm:hidden"
            >
              <span className="text-[#0B0B0F] hover:text-[#2F9E44] font-semibold font-serif">
                Register here
              </span>
